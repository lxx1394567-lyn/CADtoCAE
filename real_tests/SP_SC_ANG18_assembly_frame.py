...
ASSEMBLY_DATA = json.loads(r"""{
  "meta": {
    "project_code": "SP_SC_ANG18",
    "model_name": "SP_SC_ANG18",
    "source_excel": "F:/Codex/CADtoCAE/real_tests/SP_SC_ANG18_coordinate_formula_simple_fixed.xlsx",
    "source_components": "F:/Codex/CADtoCAE/real_tests/SP_SC_ANG18_create_parts_in_cae.py",
  ...
  "points": {
    ...
    "C": {
      ...
      "x_m": -1.5913344560225142,
      "y_m": 0.0,
      "z_m": 2.578070296500714,
      "status": "需人工确认",
    ...
    "E": {
      ...
      "x_m": 1.5557115563981487,
      "y_m": 0.0,
      "z_m": 3.600607530887415,
      "status": "需人工确认",
    ...
    "G_global": {
      ...
      "x_m": -1.8956725412369635,
      "y_m": 0.0,
      "z_m": 2.479184858300731,
      "status": "需人工确认",
      "note": "Derived global position of beam local origin G"
    }
  },
  "beam_anchor": {
    "part_name": "P_SP_SC_ANG18_INCLINED_BEAM",
    "local_point_name": "F",
    "local_point": [
      0.0,
      0.0375,
  ...
  "members": [
    {
      ...
      "part_name": "P_SP_SC_ANG18_COLUMN_DOWN",
      "component_code": "COLUMN_DOWN",
      "instance_name": "I_SP_SC_ANG18_COLUMN_DOWN",
      "local_anchor": [
        0.0,
        0.0,
        0.0
      ],
      "global_anchor_name": "O",
      "global_anchor": [
        0.0,
        0.0,
        0.0
    ...
    },
    {
      "name": "COLUMN_UP",
      "phase": "step01_columns",
      "part_name": "P_SP_SC_ANG18_COLUMN_UP",
      "component_code": "COLUMN_UP",
      "instance_name": "I_SP_SC_ANG18_COLUMN_UP",
      "local_anchor": [
        0.0,
        0.0,
        2.05
    ...
    },
    {
      ...
      "instance_name": "I_SP_SC_ANG18_INCLINED_BEAM",
      "local_anchor": [
        0.0,
        0.0375,
        2.009
    ...
    },
    {
      ...
      "part_name": "P_SP_SC_ANG18_BRACE_FRONT",
      "component_code": "BRACE_FRONT",
      "instance_name": "I_SP_SC_ANG18_BRACE_FRONT",
      "local_anchor": [
        0.0,
        0.035,
        0.0
      ...
      "rotate_y_deg": -45.255935235513995,
      "roll_about_axis_deg": -90.0,
      "translation": [
        -0.1,
        -0.035,
    ...
    },
    {
      "name": "BRACE_REAR",
      "phase": "step03_main_frame",
      "part_name": "P_SP_SC_ANG18_BRACE_REAR",
      "component_code": "BRACE_REAR",
      "instance_name": "I_SP_SC_ANG18_BRACE_REAR",
      "local_anchor": [
        0.0,
        0.035,
        0.0
      ...
      "rotate_y_deg": 30.205531638698933,
      "roll_about_axis_deg": -90.0,
      "translation": [
        0.1,
        -0.035,
  ...
  "required_part_names": [
    "P_SP_SC_ANG18_COLUMN_DOWN",
    "P_SP_SC_ANG18_COLUMN_UP",
    "P_SP_SC_ANG18_INCLINED_BEAM",
    "P_SP_SC_ANG18_BRACE_FRONT",
    "P_SP_SC_ANG18_BRACE_REAR"
  ],
  "checks": {
    "GC_GF_GE_ORDER": {
      "calc_value": "GC=0.320000, GF=2.009000, GE=3.629000",
    ...
    "BC": {
      "calc_value": 2.0997071846135302,
      "reference_value": 2.105,
      "error": -0.005292815386469751,
      "tolerance": 0.01,
      "passed": "通过",
      "status": "需人工确认"
    },
    "DE": {
      "calc_value": 2.89346404141506,
      "reference_value": 2.899,
      "error": -0.005535958584939937,
      "tolerance": 0.01,
      "passed": "通过",
      "status": "需人工确认"
    }
  ...
  "member_checks": {
    ...
    "BRACE_FRONT_BC": {
      "start": "B",
      "end": "C",
      "axis_length_m": 2.0997071846135302,
      "part_length_m": 2.114,
      "error_m": -0.014292815386469648,
      "tolerance_m": 0.01,
      "passed": "通过",
    ...
    "BRACE_REAR_DE": {
      "start": "D",
      "end": "E",
      "axis_length_m": 2.89346404141506,
      "part_length_m": 2.916,
      "error_m": -0.02253595858493984,
      "tolerance_m": 0.01,
      "passed": "通过",
      "drawing_length_check": {
        "calc_value": 2.89346404141506,
...
REPORT_PATH = _resolve_report_path("SP_SC_ANG18_full_main_frame_report.json")
SAVE_AS_PATH = r""
SUGGESTED_SAVE_AS_PATH = _resolve_report_path("SP_SC_ANG18_full_main_frame.cae")
